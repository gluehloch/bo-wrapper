...
public class EM2024Setup {
    ...
    public EM2024Setup(final BetofficeApi betofficeApi, final OpenligadbUpdateService opendDbService,
    ...
    private void em2024Halbfinale(SeasonRef seasonRef) {
        ...
        RoundRef halbfinale = api
                .addRound(seasonRef, BetofficeData.REF_GRUPPE_VIERTELFINALE, LocalDateTime.of(2024, 7, 9, 21, 0))
                .orThrow();

        // 2024-07-09
        api.createGame(seasonRef,
                BetofficeData.REF_GRUPPE_HALBFINALE,
                halbfinale.index(),
                ZonedDateTime.of(2024, 7, 9, 21, 0, 0, 0, ZoneId.of("Europe/Berlin")),
        ...
        api.createGame(seasonRef,
                BetofficeData.REF_GRUPPE_HALBFINALE,
                halbfinale.index(),
                ZonedDateTime.of(2024, 7, 10, 21, 0, 0, 0, ZoneId.of("Europe/Berlin")),
                BetofficeData.REF_NIEDERLANDE,
                BetofficeData.REF_ENGLAND);
    }

    private void em2024Viertelfinale(SeasonRef seasonRef) {
        api.addGroup(seasonRef, BetofficeData.REF_GRUPPE_VIERTELFINALE).orThrow();

        RoundRef viertelfinale = api
                .addRound(seasonRef, BetofficeData.REF_GRUPPE_VIERTELFINALE, LocalDateTime.of(2024, 7, 4, 18, 0))
                .orThrow();
        ...
        api.createGame(seasonRef,
                ...
                viertelfinale.index(),
                ZonedDateTime.of(2024, 7, 5, 18, 0, 0, 0, ZoneId.of("Europe/Berlin")),
                BetofficeData.REF_SPANIEN,
                BetofficeData.REF_DEUTSCHLAND);
        api.createGame(seasonRef,
                BetofficeData.REF_GRUPPE_VIERTELFINALE,
                viertelfinale.index(),
                ZonedDateTime.of(2024, 7, 5, 21, 0, 0, 0, ZoneId.of("Europe/Berlin")),
        ...
        api.createGame(seasonRef,
                BetofficeData.REF_GRUPPE_VIERTELFINALE,
                viertelfinale.index(),
                ZonedDateTime.of(2024, 7, 6, 18, 0, 0, 0, ZoneId.of("Europe/Berlin")),
                BetofficeData.REF_ENGLAND,
                BetofficeData.REF_SCHWEIZ);
        api.createGame(seasonRef,
                BetofficeData.REF_GRUPPE_VIERTELFINALE,
                viertelfinale.index(),
    ...
    private void em2024Achtelfinale(SeasonRef seasonRef) {
        ...
        api.createGame(seasonRef, BetofficeData.REF_GRUPPE_ACHTELFINALE, achtelfinale.index(),
                ZonedDateTime.of(2024, 6, 29, 18, 0, 0, 0, ZoneId.of("Europe/Berlin")), BetofficeData.REF_SCHWEIZ,
                BetofficeData.REF_ITALIEN);

        api.createGame(seasonRef, BetofficeData.REF_GRUPPE_ACHTELFINALE, achtelfinale.index(),
                ZonedDateTime.of(2024, 6, 29, 21, 0, 0, 0, ZoneId.of("Europe/Berlin")), BetofficeData.REF_DEUTSCHLAND,
                BetofficeData.REF_DAENEMARK);

        // 2024-06-30
        api.createGame(seasonRef, BetofficeData.REF_GRUPPE_ACHTELFINALE, achtelfinale.index(),
                ZonedDateTime.of(2024, 6, 30, 18, 0, 0, 0, ZoneId.of("Europe/Berlin")), BetofficeData.REF_ENGLAND,
                BetofficeData.REF_SLOWAKEI);

        api.createGame(seasonRef, BetofficeData.REF_GRUPPE_ACHTELFINALE, achtelfinale.index(),
                ZonedDateTime.of(2024, 6, 30, 21, 0, 0, 0, ZoneId.of("Europe/Berlin")), BetofficeData.REF_SPANIEN,
                BetofficeData.REF_GEORGIEN);

        // 2024-07-01
        api.createGame(seasonRef, BetofficeData.REF_GRUPPE_ACHTELFINALE, achtelfinale.index(),
                ZonedDateTime.of(2024, 7, 1, 18, 0, 0, 0, ZoneId.of("Europe/Berlin")), BetofficeData.REF_FRANKREICH,
                BetofficeData.REF_BELGIEN);

        api.createGame(seasonRef, BetofficeData.REF_GRUPPE_ACHTELFINALE, achtelfinale.index(),
                ZonedDateTime.of(2024, 7, 1, 21, 0, 0, 0, ZoneId.of("Europe/Berlin")), BetofficeData.REF_PORTUGAL,
                BetofficeData.REF_SLOWENIEN);

        // 2024-07-02
        api.createGame(seasonRef, BetofficeData.REF_GRUPPE_ACHTELFINALE, achtelfinale.index(),
                ZonedDateTime.of(2024, 7, 2, 18, 0, 0, 0, ZoneId.of("Europe/Berlin")), BetofficeData.REF_RUMAENIEN,
                BetofficeData.REF_NIEDERLANDE);

        api.createGame(seasonRef, BetofficeData.REF_GRUPPE_ACHTELFINALE, achtelfinale.index(),
                ZonedDateTime.of(2024, 7, 2, 21, 0, 0, 0, ZoneId.of("Europe/Berlin")), BetofficeData.REF_OESTERREICH,
                BetofficeData.REF_TUERKEI);
    }

    private void createGeorgien() {
    ...
    private void em2024DritterSpieltag(SeasonRef seasonRef, RoundRef round3) {
        ...
        api.createGame(seasonRef, BetofficeData.REF_GRUPPE_A, round3.index(),
                ZonedDateTime.of(2024, 6, 23, 21, 0, 0, 0, ZoneId.of("Europe/Berlin")), BetofficeData.REF_SCHWEIZ,
                BetofficeData.REF_DEUTSCHLAND);

        api.createGame(seasonRef, BetofficeData.REF_GRUPPE_A, round3.index(),
                ZonedDateTime.of(2024, 6, 23, 21, 0, 0, 0, ZoneId.of("Europe/Berlin")), BetofficeData.REF_SCHOTTLAND,
                BetofficeData.REF_UNGARN);

        // 2024-06-24
        api.createGame(seasonRef, BetofficeData.REF_GRUPPE_B, round3.index(),
                ZonedDateTime.of(2024, 6, 24, 21, 0, 0, 0, ZoneId.of("Europe/Berlin")), BetofficeData.REF_ALBANIEN,
                BetofficeData.REF_SPANIEN);
        api.createGame(seasonRef, BetofficeData.REF_GRUPPE_B, round3.index(),
                ZonedDateTime.of(2024, 6, 24, 21, 0, 0, 0, ZoneId.of("Europe/Berlin")), BetofficeData.REF_KROATIEN,
                BetofficeData.REF_ITALIEN);

        // 2024-06-25
        api.createGame(seasonRef, BetofficeData.REF_GRUPPE_D, round3.index(),
                ZonedDateTime.of(2024, 6, 25, 18, 0, 0, 0, ZoneId.of("Europe/Berlin")), BetofficeData.REF_FRANKREICH,
                BetofficeData.REF_POLEN);
        api.createGame(seasonRef, BetofficeData.REF_GRUPPE_D, round3.index(),
                ZonedDateTime.of(2024, 6, 25, 18, 0, 0, 0, ZoneId.of("Europe/Berlin")), BetofficeData.REF_NIEDERLANDE,
                BetofficeData.REF_OESTERREICH);

        // 2024-06-25
        api.createGame(seasonRef, BetofficeData.REF_GRUPPE_C, round3.index(),
                ZonedDateTime.of(2024, 6, 25, 21, 0, 0, 0, ZoneId.of("Europe/Berlin")), BetofficeData.REF_ENGLAND,
                BetofficeData.REF_SLOWENIEN);
        api.createGame(seasonRef, BetofficeData.REF_GRUPPE_C, round3.index(),
                ZonedDateTime.of(2024, 6, 25, 21, 0, 0, 0, ZoneId.of("Europe/Berlin")), BetofficeData.REF_DAENEMARK,
                BetofficeData.REF_SERBIEN);

        // 2024-06-26
        api.createGame(seasonRef, BetofficeData.REF_GRUPPE_E, round3.index(),
                ZonedDateTime.of(2024, 6, 26, 18, 0, 0, 0, ZoneId.of("Europe/Berlin")), BetofficeData.REF_UKRAINE,
                BetofficeData.REF_BELGIEN);
        api.createGame(seasonRef, BetofficeData.REF_GRUPPE_E, round3.index(),
                ZonedDateTime.of(2024, 6, 26, 18, 0, 0, 0, ZoneId.of("Europe/Berlin")), BetofficeData.REF_SLOWAKEI,
                BetofficeData.REF_RUMAENIEN);
        api.createGame(seasonRef, BetofficeData.REF_GRUPPE_F, round3.index(),
                ZonedDateTime.of(2024, 6, 26, 21, 0, 0, 0, ZoneId.of("Europe/Berlin")), BetofficeData.REF_TSCHECHIEN,
                BetofficeData.REF_TUERKEI);
        api.createGame(seasonRef, BetofficeData.REF_GRUPPE_F, round3.index(),
                ZonedDateTime.of(2024, 6, 26, 21, 0, 0, 0, ZoneId.of("Europe/Berlin")), BetofficeData.REF_GEORGIEN,
                BetofficeData.REF_PORTUGAL);
    }
    ...
    private void setupEM2024Vorrunde() {
        ...
        Set<Nickname> nicknames = Set.of(Nickname.of("Frosch"), Nickname.of("Steffen"), Nickname.of("mrTipp"),
                Nickname.of("Jogi"), Nickname.of("Peter"),
    ...
    private void em2024ZweiterSpieltag(SeasonRef seasonRef, RoundRef runde2) {
        ...
        api.createGame(seasonRef, BetofficeData.REF_GRUPPE_B, runde2.index(),
                ZonedDateTime.of(2024, 6, 19, 15, 0, 0, 0, ZoneId.of("Europe/Berlin")), BetofficeData.REF_KROATIEN,
                BetofficeData.REF_ALBANIEN);

        api.createGame(seasonRef, BetofficeData.REF_GRUPPE_A, runde2.index(),
                ZonedDateTime.of(2024, 6, 19, 18, 0, 0, 0, ZoneId.of("Europe/Berlin")), BetofficeData.REF_DEUTSCHLAND,
                BetofficeData.REF_UNGARN);

        api.createGame(seasonRef, BetofficeData.REF_GRUPPE_A, runde2.index(),
                ZonedDateTime.of(2024, 6, 19, 21, 0, 0, 0, ZoneId.of("Europe/Berlin")), BetofficeData.REF_SCHOTTLAND,
                BetofficeData.REF_SCHWEIZ);

        // 2024-06-20
        api.createGame(seasonRef, BetofficeData.REF_GRUPPE_C, runde2.index(),
                ZonedDateTime.of(2024, 6, 20, 15, 0, 0, 0, ZoneId.of("Europe/Berlin")), BetofficeData.REF_SLOWENIEN,
                BetofficeData.REF_SERBIEN);

        api.createGame(seasonRef, BetofficeData.REF_GRUPPE_C, runde2.index(),
                ZonedDateTime.of(2024, 6, 20, 18, 0, 0, 0, ZoneId.of("Europe/Berlin")), BetofficeData.REF_DAENEMARK,
                BetofficeData.REF_ENGLAND);

        api.createGame(seasonRef, BetofficeData.REF_GRUPPE_B, runde2.index(),
                ZonedDateTime.of(2024, 6, 20, 21, 0, 0, 0, ZoneId.of("Europe/Berlin")), BetofficeData.REF_SPANIEN,
                BetofficeData.REF_ITALIEN);

        // 2024-06-21
        api.createGame(seasonRef, BetofficeData.REF_GRUPPE_E, runde2.index(),
                ZonedDateTime.of(2024, 6, 21, 15, 0, 0, 0, ZoneId.of("Europe/Berlin")), BetofficeData.REF_SLOWAKEI,
                BetofficeData.REF_UKRAINE);

        api.createGame(seasonRef, BetofficeData.REF_GRUPPE_D, runde2.index(),
                ZonedDateTime.of(2024, 6, 21, 18, 0, 0, 0, ZoneId.of("Europe/Berlin")), BetofficeData.REF_POLEN,
                BetofficeData.REF_OESTERREICH);

        api.createGame(seasonRef, BetofficeData.REF_GRUPPE_D, runde2.index(),
                ZonedDateTime.of(2024, 6, 21, 21, 0, 0, 0, ZoneId.of("Europe/Berlin")), BetofficeData.REF_NIEDERLANDE,
                BetofficeData.REF_FRANKREICH);

        // 2024-06-22
        api.createGame(seasonRef, BetofficeData.REF_GRUPPE_F, runde2.index(),
                ZonedDateTime.of(2024, 6, 22, 15, 0, 0, 0, ZoneId.of("Europe/Berlin")), BetofficeData.REF_GEORGIEN,
                BetofficeData.REF_TSCHECHIEN);

        api.createGame(seasonRef, BetofficeData.REF_GRUPPE_F, runde2.index(),
                ZonedDateTime.of(2024, 6, 22, 18, 0, 0, 0, ZoneId.of("Europe/Berlin")), BetofficeData.REF_TUERKEI,
                BetofficeData.REF_PORTUGAL);

        api.createGame(seasonRef, BetofficeData.REF_GRUPPE_E, runde2.index(),
                ZonedDateTime.of(2024, 6, 22, 21, 0, 0, 0, ZoneId.of("Europe/Berlin")), BetofficeData.REF_BELGIEN,
                BetofficeData.REF_RUMAENIEN);
    }
    ...
    private void em2024ErsterSpieltag(SeasonRef seasonRef, RoundRef runde1) {
        ...
        api.createGame(seasonRef, BetofficeData.REF_GRUPPE_A, runde1.index(),
                ZonedDateTime.of(2024, 6, 14, 21, 0, 0, 0, ZoneId.of("Europe/Berlin")), BetofficeData.REF_DEUTSCHLAND,
                BetofficeData.REF_SCHOTTLAND);

        // 2024-06-15
        api.createGame(seasonRef, BetofficeData.REF_GRUPPE_A, runde1.index(),
                ZonedDateTime.of(2024, 6, 15, 15, 0, 0, 0, ZoneId.of("Europe/Berlin")), BetofficeData.REF_UNGARN,
                BetofficeData.REF_SCHWEIZ);

        api.createGame(seasonRef, BetofficeData.REF_GRUPPE_B, runde1.index(),
                ZonedDateTime.of(2024, 6, 15, 18, 0, 0, 0, ZoneId.of("Europe/Berlin")), BetofficeData.REF_SPANIEN,
                BetofficeData.REF_KROATIEN);

        api.createGame(seasonRef, BetofficeData.REF_GRUPPE_B, runde1.index(),
                ZonedDateTime.of(2024, 6, 15, 21, 0, 0, 0, ZoneId.of("Europe/Berlin")), BetofficeData.REF_ITALIEN,
                BetofficeData.REF_ALBANIEN);

        // 2024-06-16
        api.createGame(seasonRef, BetofficeData.REF_GRUPPE_D, runde1.index(),
                ZonedDateTime.of(2024, 6, 16, 15, 0, 0, 0, ZoneId.of("Europe/Berlin")), BetofficeData.REF_POLEN,
                BetofficeData.REF_NIEDERLANDE);

        api.createGame(seasonRef, BetofficeData.REF_GRUPPE_C, runde1.index(),
                ZonedDateTime.of(2024, 6, 16, 18, 0, 0, 0, ZoneId.of("Europe/Berlin")), BetofficeData.REF_SLOWENIEN,
                BetofficeData.REF_DAENEMARK);

        api.createGame(seasonRef, BetofficeData.REF_GRUPPE_C, runde1.index(),
                ZonedDateTime.of(2024, 6, 16, 21, 0, 0, 0, ZoneId.of("Europe/Berlin")), BetofficeData.REF_SERBIEN,
                BetofficeData.REF_ENGLAND);

        // 2024-06-17
        api.createGame(seasonRef, BetofficeData.REF_GRUPPE_E, runde1.index(),
                ZonedDateTime.of(2024, 6, 17, 15, 0, 0, 0, ZoneId.of("Europe/Berlin")), BetofficeData.REF_RUMAENIEN,
                BetofficeData.REF_UKRAINE);

        api.createGame(seasonRef, BetofficeData.REF_GRUPPE_E, runde1.index(),
                ZonedDateTime.of(2024, 6, 17, 18, 0, 0, 0, ZoneId.of("Europe/Berlin")), BetofficeData.REF_BELGIEN,
                BetofficeData.REF_SLOWAKEI);

        api.createGame(seasonRef, BetofficeData.REF_GRUPPE_D, runde1.index(),
                ZonedDateTime.of(2024, 6, 17, 21, 0, 0, 0, ZoneId.of("Europe/Berlin")), BetofficeData.REF_OESTERREICH,
                BetofficeData.REF_FRANKREICH);

        // 2024-06-18
        api.createGame(seasonRef, BetofficeData.REF_GRUPPE_F, runde1.index(),
                ZonedDateTime.of(2024, 6, 18, 18, 0, 0, 0, ZoneId.of("Europe/Berlin")), BetofficeData.REF_TUERKEI,
                BetofficeData.REF_GEORGIEN);

        api.createGame(seasonRef, BetofficeData.REF_GRUPPE_F, runde1.index(),
                ZonedDateTime.of(2024, 6, 18, 21, 0, 0, 0, ZoneId.of("Europe/Berlin")), BetofficeData.REF_PORTUGAL,
                BetofficeData.REF_TSCHECHIEN);
    }
